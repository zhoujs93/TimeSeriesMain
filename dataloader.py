...
class TrainDataset(Dataset):
    def __init__(self, data_path, data_name, num_class, data = None, label = None):
        if data is not None:
            self.data = data
            self.label = label
        else:
...
class TestDataset(Dataset):
    def __init__(self, data_path, data_name, num_class, data = None, label = None, v = None):
        if data is not None:
            self.data = data
            self.label = label
            self.v = v
...
class WeightedSampler(Sampler):
    def __init__(self, data_path, data_name, replacement=True, v = None):
        if v is None:
